...
[![Build](https://github.com//actions/workflows/jyotihariyale/JACKflutter.yml/badge.svg)](https://github.com/jyotihariyale/JACK/actions/workflows/flutter.yml)
[![Translation-Status](https://hosted.weblate.org/widgets/JACK/-/translations/svg-badge.svg)](https://hosted.weblate.org/engage/JACK/)
...
[Translate App on Weblate](https://hosted.weblate.org/projects/JACK/translations/)
...
```
Copyright © 2022 Jyoti Hiariyale

JACK is a free software licensed under GPL v3.0
...
See the [GNU General Public License](https://github.com/jyotihariyale/JACK/blob/main/LICENSE) for more details.
...
Contributions are welcome. Please read our [contributing guidelines](https://github.com/jyotihariyale/JACK/blob/main/CONTRIBUTING.md) before contributing.

## Facing any Issue?

Have a look at some [common Issues](https://github.com/jyotihariyale/JACK/wiki/Common-Issues) that you might face. If your problem is not there, feel free to open an Issue :)

## Want to test Beta Versions? Need help??

You can join our [Telegram Channel](https://t.me/JACK_official) or [Telegram Group](https://t.me/joinchat/fHDC1AWnOhw0ZmI9), if you have any query, or need help with something as well as to get beta updates of the project.
...
To read full changelog visit the [wiki page](https://github.com/Sangwan5688/JACK/wiki/Changelog)
